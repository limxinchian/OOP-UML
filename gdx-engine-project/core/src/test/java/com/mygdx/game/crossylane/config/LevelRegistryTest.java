...
public class LevelRegistryTest {
    ...
    public void defaultLevelsUseSingleStartLineTrafficLight() {
        ...
        assertLevelLight(registry.getLevel(1), 4f, -50, 50);
        assertLevelLight(registry.getLevel(2), 3.5f, -50, 50);
        assertLevelLight(registry.getLevel(3), 2.5f, -75, 75);
        assertLevelLight(registry.getLevel(4), 2f, -100, 100);
        assertLevelLight(registry.getLevel(5), 1.5f, -150, 150);
    }
