...
public class ResultScene implements IScene<CrossyLaneSceneKey> {
    ...
    public void update(float delta) {
        ...
        float menuWidth = MathUtil.clamp(screenW * 0.22f, 300f, 420f);
        float buttonHeight = MathUtil.clamp(screenH * 0.075f, 50f, 68f);
        float buttonGap = MathUtil.clamp(screenH * 0.022f, 16f, 24f);

        float titleHeight = MathUtil.clamp(screenH * 0.09f, 74f, 94f);

        float scoreBoxHeight = MathUtil.clamp(screenH * 0.06f, 42f, 52f);
    ...
    public void render() {
        ...
        float titleWidth = MathUtil.clamp(screenW * 0.28f, 340f, 500f);
        float titleHeight = MathUtil.clamp(screenH * 0.09f, 74f, 94f);
