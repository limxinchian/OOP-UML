package com.mygdx.game.crossylane.app;
...
import com.mygdx.game.crossylane.scene.CrossyLaneSceneKey;
import com.mygdx.game.crossylane.scene.CustomSetupScene;
import com.mygdx.game.crossylane.scene.GameplayScene;
import com.mygdx.game.crossylane.scene.InstructionScene;
import com.mygdx.game.crossylane.scene.MainMenuScene;
import com.mygdx.game.crossylane.scene.ResultScene;
import com.mygdx.game.crossylane.scene.SettingsScene;
import com.mygdx.game.crossylane.scene.PauseScene;
...
public class GameMaster extends ApplicationAdapter {
    ...
    @Override
    public void create() {
        engine = new EngineCore<>(CrossyLaneConfig.WORLD_WIDTH, CrossyLaneConfig.WORLD_HEIGHT);
