...
import com.mygdx.game.crossylane.entity.CarEntity;
import com.mygdx.game.crossylane.entity.EntityFactory;
import com.mygdx.game.crossylane.entity.GoalZoneEntity;
import com.mygdx.game.crossylane.entity.GrassZoneEntity;
import com.mygdx.game.crossylane.entity.PlayerEntity;
import com.mygdx.game.crossylane.entity.CoinEntity;
import com.mygdx.game.crossylane.event.CoinCollectedEvent;
import com.mygdx.game.crossylane.event.GoalReachedEvent;
...
import com.mygdx.game.crossylane.movement.CarWrapSystem;
...
public class GameplayScene implements IScene<CrossyLaneSceneKey> {
    ...
    @Override
    public void render() {
        // Let the engine apply its viewport and clear the screen
        ioManager.getOutput().beginFrame(0.20f, 0.60f, 0.20f, 1f);

        // Apply the engine's world projection to this scene's own renderers
        // so they respect the viewport even when the window is resized/fullscreened
