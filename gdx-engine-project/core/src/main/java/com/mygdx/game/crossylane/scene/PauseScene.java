...
public class PauseScene implements IScene<CrossyLaneSceneKey> {
    ...
    public void update(float delta) {
        ...
        float menuWidth = MathUtil.clamp(screenW * 0.24f, 300f, 420f);
        float buttonHeight = MathUtil.clamp(screenH * 0.072f, 50f, 68f);
        float buttonGap = MathUtil.clamp(screenH * 0.020f, 14f, 22f);

        float titleHeight = MathUtil.clamp(screenH * 0.09f, 72f, 92f);
    ...
    public void render() {
        ...
        float titleWidth = MathUtil.clamp(screenW * 0.24f, 280f, 420f);
        float titleHeight = MathUtil.clamp(screenH * 0.09f, 72f, 92f);
